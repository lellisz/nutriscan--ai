...
const IconHistory = ({ active }) => (
  <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
    <circle cx="11" cy="11" r="8"
      stroke={active ? '#000' : '#C0C0C0'} strokeWidth="1.7" />
...
const IconScan = () => (
  <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
    <rect x="2" y="5" width="18" height="13" rx="2.5"
      stroke="#FFFFFF" strokeWidth="1.7" />
    <circle cx="11" cy="11.5" r="3.5"
      stroke="#FFFFFF" strokeWidth="1.7" />
    <path d="M15 5l1.5-2.5h-3L15 5z"
      stroke="#FFFFFF" strokeWidth="1.4" strokeLinejoin="round" />
  </svg>
);
    ...
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
        ...
        <svg width="17" height="12" viewBox="0 0 17 12" fill="none">
          <rect x="0"    y="3" width="3" height="9" rx="1" fill="#000" opacity=".25" />
          <rect x="4.5"  y="2" width="3" height="10" rx="1" fill="#000" opacity=".45" />
          <rect x="9"    y="0" width="3" height="12" rx="1" fill="#000" opacity=".65" />
          <rect x="13.5" y="0" width="3" height="12" rx="1" fill="#000" />
        </svg>
        {/* WiFi */}
        <svg width="16" height="12" viewBox="0 0 16 12" fill="none">
          <path d="M8 2C5 2 2.5 3.5 1 5.5L3 7.5C4 6 5.9 5 8 5s4 1 5 2.5l2-2C13.5 3.5 11 2 8 2z" fill="#000" opacity=".45" />
          <path d="M8 6c-1.5 0-2.8.6-3.7 1.5l2 2c.4-.4 1-.7 1.7-.7s1.3.3 1.7.7l2-2C10.8 6.6 9.5 6 8 6z" fill="#000" opacity=".65" />
          <circle cx="8" cy="11" r="1.5" fill="#000" />
        </svg>
        {/* Battery */}
        <svg width="25" height="12" viewBox="0 0 25 12" fill="none">
          <rect x=".5" y=".5" width="21" height="11" rx="3.5" stroke="#000" strokeOpacity=".35" />
          <rect x="22" y="4" width="3" height="4" rx="1" fill="#000" opacity=".4" />
    ...
    >
      {NAV_ITEMS.map((item) => {
          ...
          return (
            ...
            >
              <div
                ...
                style={{
                  background: '#000000',
                  boxShadow: '0 0 0 4px #FFFFFF, 0 4px 16px rgba(0,0,0,0.18)',
        ...
        return (
          ...
          >
            {/* Indicador de linha no topo — barra preta */}
            {isActive && (
              <div style={{
                position: 'absolute',
                top: 0,
            ...
            <span
              ...
              style={{ color: isActive ? '#000000' : '#B0B0B0' }}
            >
              {item.label}
            </span>
          </div>
